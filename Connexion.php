	...
	<section class="page-compte compte container-fluid">
		...
		<form>
			<div class="Compte">
				...
				<h1>Bonjour<h1>
                <p>
                <p class="Bouton1">Connectez vous à GreenMarket ou <a href="Inscription.html">inscrivez vous</a>
                <br><br>
				<label class="label" for="myEmail">Pseudo ou E-mail: </label> <br>
				<input type="text" class="maConnection" name="monEmail" id="monEmail" />
				<br><br>
				<label class="label" for="monMDP">Mot de passe11111: </label> <br>
				<input type="mdp" class="maConnection" name="monMDP" id="monMDP" /> <br> 
				<a class="MDPO" href="MotdePasse.html">Mot  ? <br></a> 
				<br>
